...
const CatalogPage = () => {
  ...
  return (
    <div>
      <div className=" sm:text-3xl pt-7 pb-7 uppercase text-center font-bold text-7xl border-zinc-950 border-b-2" style={{ marginBottom: "-1px" }}>каталог</div>
          ...
          <div className="mt-16 flex justify-center items-center gap-3 mb-14">
            {Array.from({ length: Math.ceil(data.length / itemsPerPage) }, (_, index) => (
              <button
                ...
                className={`hover:bg-black hover:text-zinc-50 ${currentPage === index + 1 ? 'active' : ''}`}
                key={index}
